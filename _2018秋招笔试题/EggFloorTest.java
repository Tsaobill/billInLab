 ...
 * @version 1.0
 * @created by bill
 * @on 2018-10-12 上午10:56
 **/
public class EggFloorTest {
        ...
        for(int n=2; n<=egg; n++){
            for(int m=1; m<=num; m++){
                for(int k=1; k<m; k++){
                    ...
                    //      没有区别！是的在已知k层不碎的情况下，测试k+1~m层的方法和测试1~m-k没区别，所以可以写成 1+f[n][m-k] 其中1表示为在k层的那一次测试
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countMinSetp(2,100));
    }
}
